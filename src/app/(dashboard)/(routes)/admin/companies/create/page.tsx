...
toast.success("company created succesfully")        }
    ...
    return (<div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6">
        ...
        <div>
            ...
            <p className="text-sm text-neutral-500">What would You Like to name your CompanyName? Don&apos;t worry, you can change this later
...
<FormControl>
    ...
    placeholder="e.g 'Hoping Minds"
    {...field}
    />
</FormControl>
<FormDescription>Name of this job</FormDescription>
