...
export const CompanyOverview= ({ initialData,    companyId }: CompanyOverviewFormProps) => {
    ...
    <div className="mt-6 border bg-neutral-100 rounded-md p-4">
     ...
     Company OverView
      ...
      {!isEditing && (
                ...
                <div className={cn("text-sm mt-2", !initialData.overview&& "text-neutral-500")}>

                  {initialData.overview && "No Description"}
