...
const selectedOption = options?.find(
  (option) => option.value === String(initialData.shiftTiming)
);
  ...
  return (
    <div className="mt-6 border bg-neutral-100 rounded-md p-4">
      ...
      {!isEditing && <p className={cn("text-sm mt-2", !initialData?.shiftTiming && "text-neutral-500 italic")}>{selectedOption?.label || "No Timing Added"}</p>}
