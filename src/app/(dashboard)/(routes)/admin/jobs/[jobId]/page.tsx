...
import { ArrowLeft, Building2, File, LayoutDashboard, ListCheck, ListChecks, Network } from "lucide-react";
...
import { YearsOfExperienceForm } from "./_components/work-experience";
import { JobDescription } from "./_components/job-description";
import { TagsForm } from "./_components/tags-form";
import { CompanyForm } from "./_components/company-form";
import { SocialContactForm } from "../../companies/[companyId]/socail-contact";
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between my-4">
        ...
        <JobPublishAction jobId={jobId} isPublished={job.isPublished} disabled={!isComplete} />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
        ...
        <div className="space-y-6">
          ...
          {/* <div className="flex items-center gap-x-2">
            ...
            <h2 className="text-xl text-neutral-500">Company Social Contact</h2>
          </div>  */}
...
<div>
  <div className="flex items-center gap-x-2">
     ...
     {/* companies detials */}
             <CompanyForm initialData={job} jobId={job.id}
